...
print("\nKnowledge Source:")
print("The agent uses the general knowledge embedded in the GPT-3.5-turbo model to answer the question. It does not use any external or custom knowledge base.")
